...
areaSeries.setData([
    ...
    <main>
      ...
      <div class="row">
        <div class="col-md-4" id="curve_chart" style="height: 40%;"></div>
        <div class="col-md-4" id="curve_chart2" style="height: 40%;"></div>
        <div class="col-md-4" id="curve_chart3" style="height: 40%;"></div>
      </div>
    </main>
  </body>
</html>